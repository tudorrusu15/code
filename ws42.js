document.addEventListener('DOMContentLoaded', function() {
  ...
  function calculateTotalComparePrice(compareAtPrice, quantity) {
...
if (quantity >= 4) {
    ...
    function fetchCompareAtPrice(checkout, quantity, imageId, nameId, variant) {
    ...
    .then(data => {
        ...
        updateCartDisplay(checkout, compareAtPrice, quantity)
  ...
  function updateGiftDisplay() {
    ...
    function updateCartDisplay(checkout, compareAtPrice, quantity) {
        ...
        const totalComparePrice = calculateTotalComparePrice(compareAtPrice, quantity);
