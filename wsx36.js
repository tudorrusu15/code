...
if (checkoutURL) {
    ...
    const gift2Price = document.getElementById('gift-2-variant-id').value;
    const gift2NameValue = document.getElementById('gift-2-variant-id').value;
    const gift2ImageValue = document.getElementById('gift-2-variant-id').value;
    const gift3VariantId = document.getElementById('gift-3-variant-id').value;
    const gift3Price = document.getElementById('gift-2-variant-id').value;
    const gift3NameValue = document.getElementById('gift-2-variant-id').value;
    const gift3ImageValue = document.getElementById('gift-2-variant-id').value;
    const gift4VariantId = document.getElementById('gift-4-variant-id').value;
    const gift4Price = document.getElementById('gift-2-variant-id').value;
    const gift4NameValue = document.getElementById('gift-2-variant-id').value;
    const gift4ImageValue = document.getElementById('gift-2-variant-id').value;
  ...
  function processGiftData(giftNumber) {
    ...
    updateGiftUI(imageElementId, nameElementId, imageUrl, name);
}

  processGiftDataFromHiddenElements(2);
  processGiftDataFromHiddenElements(3);
  processGiftDataFromHiddenElements(4);


  function updateGiftUI(imageId, nameId, imageUrl, name) {
    // Update the image
