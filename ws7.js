document.addEventListener('DOMContentLoaded', function() {
  ...
  function updateGiftDisplay() {
    if (quantity >= 1) {
        ...
        gift1Name.style.display = 'block'; // Show the gift name
        nogift1.style.display = 'none'; // Hide the "no gift" message
    } else {
        gift1Div.style.display = 'none'; // Hide the gift div
        gift1Name.style.display = 'none'; // Hide the gift name
        nogift1.style.display = 'block'; // Show the "no gift" message
    }
}
