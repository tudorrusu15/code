...
if (variant) {
  ...
  function updateGiftDisplay() {
    if (quantity >= 1) {
        ...
        // Populate the gift name with data from Shopify API (you'll need to fetch this data)
        gift1Name.textContent = 'Gift Name Here'; // Replace with the actual gift name
    } else {
