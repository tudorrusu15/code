...
if (checkoutURL) {
    ...
    const totalComparePice = mainProductComparePrice + (quantity >= 2 ? gift2PriceValue : 0) + (quantity >= 3 ? gift3PriceValue : 0) + (quantity >= 4 ? gift4PriceValue : 0);
    const totalSavings = totalComparePice - finalPrice;
