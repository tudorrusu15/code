...
if (checkoutURL) {
    ...
    const gift2Name = document.getElementById('gift-2-variant-id').value;
    const gift2Image = document.getElementById('gift-2-variant-id').value;
    ...
    const gift3Name = document.getElementById('gift-2-variant-id').value;
    const gift3Image = document.getElementById('gift-2-variant-id').value;
    ...
    const gift4Name = document.getElementById('gift-2-variant-id').value;
    const gift4Image = document.getElementById('gift-2-variant-id').value;
