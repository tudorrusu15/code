...
if (checkoutURL) {
    ...
    const totalComparePice = mainProductComparePrice + (quantity >= 2 ? gift2Price : 0) + (quantity >= 3 ? gift3Price : 0) + (quantity >= 4 ? gift4Price : 0);
    const bundleSavings = itemPrice + (quantity >= 2 ? gift2Price : 0) + (quantity >= 3 ? gift3Price : 0) + (quantity >= 4 ? gift4Price : 0);
