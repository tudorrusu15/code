...
},
{
    ...
    easing: 'linear',
    step: function (now) {
        itemPriceElement.textContent = '$' + now.toFixed(2);
    }
});

// Animate item-compare-price
...
},
{
    ...
    easing: 'linear',
    step: function (now) {
        itemComparePriceElement.textContent = '$' + now.toFixed(2);
    }
});

// Animate total-compare-price
$({ countNum: parseFloat(totalComparePrice.textContent.replace('$', '')) }).animate({
    countNum: compareAtPrice * quantity
},
{
    duration: 500,
    easing: 'linear',
    step: function (now) {
        totalComparePrice.textContent = '$' + now.toFixed(2);
    }
});

// Animate final-price
$({ countNum: parseFloat(finalPrice.textContent.replace('$', '')) }).animate({
    countNum: parseFloat(checkout.totalPriceV2.amount)
},
{
    duration: 500,
    easing: 'linear',
    step: function (now) {
        finalPrice.textContent = '$' + now.toFixed(2);
    }
});
